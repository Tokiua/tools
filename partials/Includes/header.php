...
<script>
// ARREGLO: Registro del Service Worker con ruta absoluta a la raíz
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('/sw.js')
            .then(reg => console.log('Nexosyne Core: Service Worker Activo en Raíz'))
...
if (typeof nexosyneCore !== 'function') {
    window.nexosyneCore = function() {
        return {
            ...
            go(id) {
                // ARREGLO: Ruta absoluta para las herramientas
